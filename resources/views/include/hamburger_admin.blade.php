<div class="flex h-screen">
    ...
    <div id="sidebar" class="w-64 bg-blue-900 text-white p-8 space-y-8 transition-all duration-300 ease-in-out transform -translate-x-full md:translate-x-0">
            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('tambah_karyawan') }}" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                ...
                <li>
                    <a href="{{ route('jadwal_kerja') }}" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-5">
                ...
                <li>
                    <a href="{{ route('layanan') }}" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                ...
                <li>
                    <a href="{{ route('laporan') }}" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                ...
                <li>
                    <a href="{{ route('data') }}" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                ...
                <li>
                    <a href="pembayaran" class="flex items-center p-2 hover:bg-teal-700 rounded">
                        <!-- Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-5">
